...
export PSAD_CONFIG="/etc/psad"
export LOGROTATE_PATH="/etc/logrotate.d"
export COLMENA_LOG_FILE="$COLMENA_LOG_PATH/colmena.log"
export COLMENA_EVENTS_LOG="$COLMENA_LOG_PATH/events.log"
export COLMENA_EVENTS_IP="$COLMENA_LOG_PATH/ip"
...
export EVENTS_LOG="$vlog/colmena/events.log"
